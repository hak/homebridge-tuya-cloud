...
export class TuyaCloudPlatformAccessory {
  ...
  constructor(
    ...
    this.platform.log.debug(`Initializing:${this.accessory.UUID}`);
    ...
    this.service.setCharacteristic(this.platform.Characteristic.Name, "test");
    ...
    setInterval(() => {
      this.platform.log.debug(`Getting Motion sensor status:${this.accessory.UUID}`);
